...
<div class="top-row">
    ...
    <div class="d-flex gap-3">
        ...
        >
            <img
                src="{{ asset('assets/images/icons/notification.png') }}"
                alt="Notifications"
            >
            <!-- Notification Popup -->
            <div
            ...
            >
                <div class="popup-header">
                    <span
                        class="popup-close"
                        data-close="notifPopup"
                    >
                        <img
                            src="{{ asset('assets/images/icons/iconoir_cancel.png') }}"
                            alt=""
                        >
                    </span>
                </div>
                <div class="notification-item">
                    <img
                        src="{{ asset('assets/images/icons/manage.png') }}"
                        alt=""
                    >
        ...
        >
            ...
            >
                ...
                <div class="profile-card">
                    ...
                    > <img
                            src="{{ asset('assets/images/icons/Icon-logout.png') }}"
                            class="img-log"alt=""
                        > Logout</button>
                </div>
            </div>

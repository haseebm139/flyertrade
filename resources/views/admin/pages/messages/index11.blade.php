...
<<<<<<< HEAD
    ...
    <div class="messages-email-container">
        ...
        <<<<<<< HEAD <div class="messages-email-container">
            <aside class="sidebars">
                <div class="search-bars">
                    ...
                    <div class="message-chat-theme">
                        <div class="chat-header">
                            ...
                            <div class="header-right">
                                <span>1 of 200</span>
                                <div class="icons">
                                    <img src="{{ asset('assets/images/icons/message-icon-prev.svg') }}"
                                        alt="Refresh Icon">
                                    <img src="{{ asset('assets/images/icons/message-icon-next.svg') }}"
                                        alt="Expand Icon">
                                </div>
                                <div class="icons">

...
@section('content')
    ...
    <div id="view-booking" class="view-booking-modal">
        ...
        <div class="modal-header" style="margin-bottom:1.563vw">
                <h2 class="page-title" style="font-size:1.146vw;font-weight: 600;line-height:1;">Transaction details</h2>
            ...
            <div class="modal-section">
                ...
                <div class="details-grid">
                    ...
                    <div>Status</div>
                    <div class="status "  style="color:#17a55a;border-color:#17a55a;font-weight:500;background:rgba(23, 165, 90, 0.1)">Pending</div>
                </div>
            </div>

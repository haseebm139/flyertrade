                    ...
                    <div class="users-toolbar">
                        <div class="toolbar-left">
                            <button class="export-btn">
                                <span class="download-icon"><img src="{{ asset('assets/images/icons/download.png') }}" alt=""></span> Export
                                CSV
                            </button>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="viw-parent">
                                    ...
                                    <a href="" class="view-btn">
                                        <img src="{{ asset('assets/images/icons/delete-icon.png') }}" alt="Delete" class="eye-icon">
                                        Delete
                                    </a>
                                </td>
                            </tr>
                ...
                <div id="roles" class="tab-content ">
                    <div class="users-toolbar">
                        <div class="toolbar-left">
                            ...
                            <button class="add-user-btn" id="openAddUserModal">+ Add role</button>
                        </div>
                        <div class="toolbar-right">
                            <input type="text" class="search-user" placeholder="Search user">
                            <button class="filter-btn" id="openFilterModal"> <span class="download-icon"><img

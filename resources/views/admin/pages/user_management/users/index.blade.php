        ...
        <tbody>
                ...
                <td>
                    <div class="user-info">
                        ...
                        <div>
                            ...
                            <p class="user-email">johnbosco@example.com</p>
                        </div>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td>
                    <div class="user-info">
                        <img
                            src="{{ asset('assets/images/icons/person-two.png') }}"
                            alt="User"
                        >
                        <div>
                ...
                <td>
                    <div class="user-info">
                        ...
                        <div>
                            ...
                            <p class="user-email">michael@example.com</p>
                        </div>
                    </div>
                </td>
                <td>789, Pqr Lane, Dubai</td>
                <td>08036528964</td>
                <td><span class="status active">Active</span></td>
                <td>
                    <div class="actions-dropdown">
                ...
                <td>
                    <div class="user-info">
                        ...
                        <div>
                            ...
                            <p class="user-email">david@example.com</p>
                        </div>
                    </div>
                </td>
                <td>222, Ghi Avenue, Dubai</td>
                <td>08036528966</td>
                <td><span class="status active">Active</span></td>
                <td>
                    <div class="actions-dropdown">
            ...
            <tr>
                ...
                <td>
                    <div class="user-info">
                        ...
                        >
                        <div>
                            <p class="user-name">Sophia Brown</p>
                            <p class="user-email">sophia@example.com</p>
                        </div>
                    </div>
                </td>
                <td>333, Jkl Road, Dubai</td>
                <td>08036528967</td>
                <td><span class="status inactive">Inactive</span></td>
                <td>
                    <div class="actions-dropdown">
            ...
            <tr>
                ...
                <td>
                    <div class="user-info">
                        ...
                        >
                        <div>
                            <p class="user-name">Chris Martin</p>
                            <p class="user-email">chris@example.com</p>
                        </div>
                    </div>
                </td>
                <td>444, Mno Street, Dubai</td>
                <td>08036528968</td>
                <td><span class="status active">Active</span></td>
                <td>
                    <div class="actions-dropdown">
            ...
            <tr>
                ...
                <td>
                    <div class="user-info">
                        ...
                        >
                        <div>
                            <p class="user-name">Olivia Taylor</p>
                            <p class="user-email">olivia@example.com</p>
                        </div>
                    </div>
                </td>
                <td>555, Qrs Avenue, Dubai</td>
                <td>08036528969</td>
                <td><span class="status inactive">Inactive</span></td>
                <td>
                    <div class="actions-dropdown">

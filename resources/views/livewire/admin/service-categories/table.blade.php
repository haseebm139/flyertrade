    ...
    <table class="theme-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="cursor:pointer;" @if ($item->providers_count > 0)
                    wire:click="$dispatch('open-user-providers-modal', { serviceId: {{ $item->id }} })" @endif>
                ...
                <td>
                    <span class="desf">{{ $item->description }}</span>
                </td>
    ...
    <div id="globalDeleteModal" class="deleteModal" style="display: none;">
        <div class="delete-card">
            ...
            <div class="delete-actions">
                <div class="delete-actions"> <button class="confirm-delete-btn"
                        wire:click="delete({{ $item->id }})">Delete</button> <button class="cancel-delete-btn"
                        wire:click="$set('confirmingId', null)">Cancel</button> </div>
            </div>
        </div>
    </div>

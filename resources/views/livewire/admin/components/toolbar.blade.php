<div>
    ...
    <div class="users-toolbar">
        <div class="toolbar-left">
            ...
            @if ($showAddButton)
                <button class="add-user-btn d-flex align-items-center gap-1" style="line-height:1" id="openAddUserModal"
                    wire:click="addItem"><i class="fa-solid fa-plus mr-3"></i> Add {{ $button_label }}</button>
            @endif
        </div>

            ...
            <thead>
                <tr>
                    ...
                    <th wire:click="sortBy('users_count')" class="sortable" style="cursor: pointer;">
                        Assignees
                        <img src="{{ asset('assets/images/icons/sort.svg') }}" class="sort-icon {{ $sortField === 'users_count' ? $sortDirection : '-' }}">
                    </th>
                    <th></th>
                </tr>
            </thead>
                            ...
                            <div class="users-info">
                                @if ($role->users->count() > 0)
                                    <div class="user-avatar">
                                        <img src="{{ asset($role->users->first()->avatar ?? 'assets/images/icons/person-one.svg') }}" alt="User" class="avatar-small">
                                    ...
                                    <div id="deleteRoleModal{{ $role->id }}" class="deleteModal"
                                        ...
                                        <div class="delete-card">
                                            <div class="delete-card-header">
                                                ...
                                                <span class="delete-close closeDeleteModal" data-id="{{ $role->id }}">&times;</span>
                                            </div>
                                            <p class="delete-text">Are you sure you want to delete role <strong>{{ $role->name }}</strong>?</p>
                                            <div class="delete-actions justify-content-start">
                                                <button class="confirm-delete-btn" wire:click="deleteRole({{ $role->id }})">Delete</button>
                                                <button class="cancel-delete-btn" data-id="{{ $role->id }}">Cancel</button>
                                            </div>
                                        </div>
                                    </div>

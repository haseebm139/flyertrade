...
<head>
    <title>Password Reset by Admin - FlyerTrade</title>
                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="left"
                            ...
                            <p style="margin: 20px 0 0 0; color: #333333;">
                                Your password has been successfully reset by the administrator. Please use the following temporary password to log in:
                            </p>
                        </td>
                    </tr>
                </table>
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                            ...
                                            <tr>
                                                <td align="left" style="padding: 20px 0 10px 0;">
                                                    <p style="margin: 0; font-size: 14px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif;">
                                                        <strong style="color: #004E42;">New Password:</strong>
                                                    </p>
                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="left"
                            ...
                            <p style="margin: 10px 0 0 0; color: #666666;">
                                For your security, please change this password immediately after logging in. If you did not request this change, please contact our support team immediately.
                            </p>
                        </td>
                    </tr>
                </table>

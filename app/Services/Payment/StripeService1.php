...
class StripeService
{
    ...
    /**
     * Create and confirm a PaymentIntent with customer association
     * 
     * @param int $amountCents Amount in cents
     * @param string $currency Currency code (e.g., 'usd')
     * @param string $paymentMethodId Stripe payment method ID
     * @param string|null $customerId Optional Stripe customer ID to attach payment method
     * @param array $metadata Additional metadata
     * @return PaymentIntent
     */
    public function createAndConfirmIntent(
        int $amountCents, 
        string $currency, 
    ...
    { 
        return PaymentIntent::create([
            'amount' => $amountCents,
            'currency' => $currency,
            'payment_method' => $paymentMethodId, // Use provided payment_method_id directly
            'confirmation_method' => 'automatic',
            'confirm' => true,             

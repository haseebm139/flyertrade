...
class ProviderServicesService
{
    ...
    public function create(array $data, $user)
    {
        ...
        if (!empty($data['services'])) {
            ...
            $service = ProviderService::create([
                ...
                'show_certificate'    => $data['services']['show_certificates'] ?? true,
                'show_certificates'   => $data['services']['show_certificates'] ?? true,
    ...
    public function update(array $data, $user, $id)
    {
        ...
        $service->update([
            ...
            'show_certificate'  => $data['services']['show_certificates'] ?? $service->show_certificate,
            'show_certificates' => $data['services']['show_certificates'] ?? $service->show_certificates,

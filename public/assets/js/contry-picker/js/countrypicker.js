    ...
    for (i = 0; i < countryInput.length; i++) {
        ...
        if (flag) {
            ...
            $.each(countries, function (index, country) {
                var flagIcon = "http://127.0.0.1:8000/assets/js/contry-picker/css/flags/" + country.code + ".png";
                countryList += "<option data-country-code='" + country.code + "' data-tokens='" + country.code + " " + country.name + "' style='padding-left:1.302vw; background-position: 0.208vw 0.365vw; background-image:url(" + flagIcon + ");background-repeat:no-repeat;' value='" + country.name + "'>" + country.name + "</option>";
            });
            ...
            countryInput.eq(i).on('loaded.bs.select', function (e) {
                ...
                button.css("background-size", '1.042vw');
                button.css("background-position", '0.521vw 0.93vw');
                button.css("padding-left", '2.083vw');
                button.css("background-repeat", 'no-repeat');
                button.css("background-image", "url('http://127.0.0.1:8000/assets/js/contry-picker/" + flagIcon + "'");
                button.show();
            });

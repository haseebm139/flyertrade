...
if (window.dashboardInitialized) {
    ...
    if (!window.showPermissionInitialized) {
        const showPermissionBtn = document.getElementById("showPermission");
        if (showPermissionBtn) {
            showPermissionBtn.addEventListener("click", function () {
        ...
        window.showPermissionInitialized = true;
    }
    ...
    if (!window.statusBtn) {
        ...
        window.statusBtn = true;
    }

    // Filter modal functionality
    if (!window.filterModalInitialized) {
